...
const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      'Enter a unique name for your wallet, then type or paste your 12 mnemonic seeds in order to generate the secret key and public key. Click "Save" to add the wallet. It will now appear in your wallet list.',
  },
  {
    number: 1,
    ...
    description:
      'On the Wallet page, click the "IMPORT WALLET" button to open an expanded view for importing your wallet.',
  },
  {
    number: 2,
    ...
    description:
      'Enter a unique name for your wallet, then select the Xode JSON file of the wallet you wish to import from your desktop. Afterward, click the "Save" button. You can now see the imported wallet in your Wallet list.',
  },
];
