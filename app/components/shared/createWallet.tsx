...
const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      'Open your Xterium Wallet Extension and set up a password for it. The password must be at least 8 characters long and include an uppercase letter, a lowercase letter, and a number. Once done, click the "SETUP PASSWORD" button. You will then be directed to the balance section of the Xterium Wallet.',
  },
  {
    number: 3,
    ...
    title: "Add Wallet",
    description:
      'To add a wallet to your extension, click the sidebar button located in the upper left corner. Then, select "Wallets". Click the "Add Wallet" button.',
  },
  {
    number: 4,
    ...
    description:
      'Provide a unique name for your wallet. To generate a mnemonic phrase, secret key, and public key, click the "Generate Mnemonic Phrase" button. Once the mnemonic phrase is generated, make sure to write it down and store it securely, as you won’t be able to recover your account if it’s lost. Then, click the "Save" button to proceed. You can now view your added wallet and make transactions on the wallet page of the Xterium Wallet Extension.|',
  },
];
          ...
          <div className="flex flex-nowrap justify-center items-center overflow-hidden mt-8">
            <div className="w-full grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 justify-items-center gap-8 mt-8">
              {steps.map(({ number }, index) => (
                <div
                  key={index}
                  className="relative flex items-center justify-center sm:px-0 md:px-1 md:px-2 lg:px-3 xl:px-4"
                >
